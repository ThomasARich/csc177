...
X = dataset[['GRE Score', 'TOEFL Score', 'CGPA']] # feature matrix of 'GRE Score', 'TOEFL Score', 'CGPA'
Y = dataset['Chance of Admit ']  # dependent variable (Chance of Admit )
...
plt.scatter(x_train_graph.loc[:, ['CGPA']].values, y_train, color='green')

# displaying the regression line of predicted Chance of admit values generated by our model.
plt.plot(x_train_graph.loc[:, ['CGPA']].values, regressor.predict(x_train), color='blue')
...
plt.scatter(x_test_graph.loc[:, ['CGPA']].values, y_test, color='green')

# displaying the regression line of predicted Chance of admission values generated by our model.
plt.plot(x_test_graph.loc[:, ['CGPA']].values, predicted_chance, color='blue')
