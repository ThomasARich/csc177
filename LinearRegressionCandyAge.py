...
X = dataset[['Height']]  # feature matrix of Height
Y = dataset['Weight']  # vector of dependent variable (Weight)
...
plt.title('Height vs Chance of admit - Training Values')
plt.xlabel('Height')
plt.ylabel('Chance of admit')
plt.show()

# displaying the values of Height in the test feature matrix (x_test) and the real Height values with a scatter plot
plt.scatter(x_test_graph.values, y_test, color='green')

# displaying the regression line of predicted Height values generated by our model.
plt.plot(x_test_graph.values, predicted_chance, color='blue')

plt.title('Height vs Chance of admit - Test Values')
plt.xlabel('Height')
plt.ylabel('Chance of admit')
plt.show()
